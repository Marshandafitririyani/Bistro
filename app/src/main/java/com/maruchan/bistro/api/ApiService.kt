...
interface ApiService {
    ...
    @GET("api/resto/filter-by-category/1")
    suspend fun bistroCategoryOne(): String

    @GET("api/resto/filter-by-category/2")
    suspend fun bistroCategoryTwo(): String

    @GET("api/resto/filter-by-category/3")
    suspend fun bistroCategorythree(): String

    @GET("api/resto/filter-by-category/4")
    suspend fun bistroCategoryfour(): String

    @GET("api/resto/filter-by-category/5")
    suspend fun bistroCategoryfive(): String

    @GET("api/resto/filter-by-category/6")
    suspend fun bistroCategorysix(): String
